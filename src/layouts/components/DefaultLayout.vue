...
const showDiscord = window.location.host.search('silknodes.io') > -1;
    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10" src="https://raw.githubusercontent.com/Silk-Nodes/brand-assests/refs/heads/main/icon/Silk_Nodes180.jpg" />
      ...
      <div class="px-2">
        ...
        <a
          v-if="showDiscord"
          href="https://discord.silknodes.io/"
          target="_blank"
